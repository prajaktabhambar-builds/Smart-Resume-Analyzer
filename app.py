...
class ResumeApp:
    ...
    def render_about(self):
        """Render Prajakta Bhambar's professional portfolio / About page."""
        import base64
        import os

        apply_modern_styles()

        # Load a local profile image if available.
        ...
        # Replace this image with Prajakta's photo when available.
        ...
        <style>
            .portfolio-hero {
                ...
                border-radius: 24px;
                background: linear-gradient(135deg, rgba(18, 32, 48, .98), rgba(38, 38, 50, .98));
        ...
        # Hero
        if image_base64:
            image_html = f'<img src="{image_base64}" class="portfolio-image" alt="Prajakta Bhambar">'
        else:
            image_html = '<div style="font-size:90px; margin-bottom:15px;">👩‍💻</div>'

        st.markdown(f"""
        <div class="portfolio-hero">
            {image_html}
            <div class="portfolio-name">Prajakta Bhambar</div>
            <div class="portfolio-role">Computer Engineering Student | Software Developer | AI/ML Enthusiast</div>
            <div class="portfolio-location">📍 Maharashtra, India</div>
            <div class="social-row">
                <a class="social-btn" href="#" target="_blank">💻 GitHub</a>
                <a class="social-btn" href="#" target="_blank">🔗 LinkedIn</a>
                <a class="social-btn" href="mailto:YOUR_EMAIL_HERE">✉️ Email</a>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        stats = [
            (stat1, "2028", "Expected Graduation"),
            (stat2, "3+", "Major Projects"),
            (stat3, "88.63%", "Diploma"),
            (stat4, "90%", "SSC"),
        ]
        ...
        <div class="section-card">
            <div class="card-text">
                I am a passionate Computer Engineering student interested in
                Software Development, AI/ML, Full-Stack Development, and
                emerging technologies. I enjoy solving real-world problems
                through innovative projects and actively participate in
                hackathons and technical activities.
                <br><br>
                My goal is to build intelligent, practical, and impactful
                technology solutions while continuously improving my technical
        ...
        with education_col:
            st.markdown("""
            <div class="section-card">
                <div class="card-title">🎓 B.Tech in Computer Engineering</div>
                <div class="card-text">
                    <b>SNJB’s Late Sau. Kantabai Bhavarlalji Jain College of Engineering, Chandwad</b>
                    <br><br>
                    Expected Graduation: <b>2028</b>
                    <br><br>
                    <b>Diploma in Computer Engineering</b><br>
                    Shri H.H. Jain Brothers Polytechnic, Chandwad<br>
                    Percentage: <b>88.63%</b>
                    <br><br>
                    SSC Percentage: <b>90%</b>
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with experience_col:
            st.markdown("""
            <div class="section-card">
                <div class="card-title">💼 Android Development Intern</div>
                <div class="card-text">
                    <b>Cognifyz IT Solutions Pvt. Ltd.</b>
                    <br><br>
                    📅 <b>10 July 2026 – 10 August 2026</b>
                    <br><br>
                    Worked on Android development tasks, application development,
                    debugging, testing, and improving mobile application functionality.
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        projects = [
            ("🤖 PersonaOS", "Agentic AI-based personalized goal-achievement assistant."),
            ("🚦 AI-Driven Smart Transportation System", "AI-based traffic monitoring, vehicle counting, incident detection, and emergency vehicle green-wave management."),
            ("📱 Student Grade Management App", "Android application using Java and SQLite for managing student grades."),
        ]
        ...
        skill_groups = {
            ...
            "AI / ML": ["Machine Learning", "Computer Vision", "YOLO", "Agentic AI"],
            "Web Development": ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
            "Tools": ["Git", "GitHub", "Android Studio", "MySQL", "SQLite"],
        }
        for category, skills in skill_groups.items():
            st.markdown(f'<div class="card-title">{category}</div>', unsafe_allow_html=True)
            st.markdown("".join(f'<span class="skill-pill">{skill}</span>' for skill in skills), unsafe_allow_html=True)

        # Achievements
        st.markdown('<div class="section-title">🏆 Achievements</div>', unsafe_allow_html=True)
        achievements = [
            "🥈 First Runner-Up – Hackspectra 2.0 Hackathon, MGM College Nanded",
            "🏆 Finalist – Hack Better Than Me Hackathon, IIIT Pune",
            "🎖️ CampusCrew 100K Milestone Honor Certificate",
        ]
        ...
        <div class="section-card">
            <div class="card-text">
                ...
                and create intelligent solutions that can make people’s lives easier.
                <br><br>
                I am particularly interested in the intersection of
                <b>Software Development, Artificial Intelligence, Computer Vision,
                and Agentic AI.</b>
                <br><br>
                I believe in continuous learning, practical development, teamwork,
        ...
        st.markdown("""
        <div class="portfolio-hero">
            <h2 style="color:white;">🚀 Let's Build Something Amazing</h2>
            <p style="color:#cccccc;">
                Explore my projects, analyze your resume, and build your professional career with Smart Resume AI.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            if st.session_state.get('is_admin', False):
                ...
                with st.expander("👤 Prajakta Admin Login"):
                    admin_email_input = st.text_input("Admin Email", key="admin_email_input")
                    admin_password = st.text_input("Password", type="password", key="admin_password_input")
                    if st.button("Login", key="login_button"):
                            try:
                                if (admin_email_input.strip().lower() == "prajakta.admin@gmail.com" and admin_password == "Prajakta@2026"):
